...
/*   Updated: 2022/10/16 00:33:05 by nickkuipers   ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int					parse_spec(char **start, t_flags *flags, va_list list, \
					int *rv);
void				parse_flags(char **start, t_flags *flags);
void				parse_hub(char **start, t_flags *flags, va_list list, \
					int *rv);
...
void				printhex(char **start, t_flags *flags, va_list list, \
					int *rv);
